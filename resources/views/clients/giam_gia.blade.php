    ...
    <div id="demo" class="carousel slide overflow-hidden" data-bs-ride="carousel" style="height: 480px;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('images/banner_sale.jpg') }}" alt="Los Angeles" class="d-block w-100 h-100">
            </div>
            <div class="carousel-item">
                <img style="height: 100%;" src="{{ asset('images/banner_sale3.jpg') }}" alt="Chicago"
                    class="d-block w-100 h-100">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/banner_sale4.jpg') }}" alt="New York" class="d-block w-100 h-100">
            </div>
        </div>
